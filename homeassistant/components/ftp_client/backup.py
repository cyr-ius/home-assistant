...
class FTPDriveBackupAgent(BackupAgent):
    ...
    async def async_download_backup(
        ...
        **kwargs: Any,
        ...
        stream = await self._ftp.client.download_stream(
    ...
    async def async_upload_backup(
        ...
        **kwargs: Any,
        ...
        async with await self._ftp.client.upload_stream(tar_path) as stream:
        ...
        async with await self._ftp.client.upload_stream(meta_path) as stream:
            async for block in stream_iter:
                await stream.write(block)
